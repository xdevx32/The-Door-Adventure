    ...
    init(size: CGSize,text:[String] ,answers:[String], points: Int) {
       ...
       // self.addChild(diamond)
        ...
        if scenariosCount == 1 {
            ...
            linesArray = ["Срещу теб имаше голям",
                          "електронен часовник:",
                          "9:45, 17ти ноември 2040 г.",
                          "Един възрастен мъж остави",
                          "закуската си, стана и се обърна",
                          "към теб.",
                          "'А, Вие дойдохте все пак.",
                          "Очаквахме Ви.'",
                          "",
                          ""]
        ...
        backgroundColor = SKColor.init(red:0.91, green:0.89, blue:0.84, alpha:1.0)
        var 😱:CGFloat = 60.0
